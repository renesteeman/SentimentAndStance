...
for(test_bias_term_vader in bias_term_values){
  ...
  predicted_sentiment_fitted <- replace(predicted_sentiment_fitted, predicted_sentiment_fitted < test_bias_term_vader - neutral_range/2, -1)
  predicted_sentiment_fitted <- replace(predicted_sentiment_fitted, predicted_sentiment_fitted > test_bias_term_vader + neutral_range/2, 1)
  predicted_sentiment_fitted <- replace(predicted_sentiment_fitted,
                                        predicted_sentiment_fitted > test_bias_term_vader - neutral_range/2 &
                                                predicted_sentiment_fitted < test_bias_term_vader + neutral_range/2,
                                        0)
...
# cat(sum(sentiment == predicted_sentiment_fitted) / length(sentiment), "% accuracy, bias ", bias_term_vader, "\n", sep = '')
# bias_term_vader = 0
# neutral_range = 0
# Use best value found
predicted_sentiment_fitted <- replace(predicted_sentiment_fitted, predicted_sentiment_fitted < bias_term_vader - neutral_range/2, -1)
predicted_sentiment_fitted <- replace(predicted_sentiment_fitted, predicted_sentiment_fitted > bias_term_vader + neutral_range/2, 1)
predicted_sentiment_fitted <- replace(predicted_sentiment_fitted,
                                      predicted_sentiment_fitted > bias_term_vader - neutral_range/2 &
                                              predicted_sentiment_fitted < bias_term_vader + neutral_range/2,
                                      0)
predicted_sentiment_fitted[1] = 0
predicted_sentiment_fitted <- as.numeric(predicted_sentiment_fitted)
